...
# 巩固除法我们需要了解 float .
2.0  # 这是 float
11.0 / 4.0  # => 2.75 对吧!这样的结果就好很多

# 这种情况下,正数和负数的整数除法都会被截断.
5 // 3  # => 1
...
# 下面是一种新的 string 格式化方法,这个方法是教常用的
"{} is a {}".format("This", "placeholder")
"{0} can be {1}".format("strings", "formatted")
# 如果不想计数，您可以使用关键字表示参数值
"{name} wants to eat {food}".format(name="Bob", food="lasagna")

# None is an object
None  # => None

# 不要使用 (==) 去拿对象和 None 比较,应该使用 (is) 代替.
"etc" is None  # => False
None is None  # => True


# (is) 用来测试对象. (is) 处理原始数据不是有效的,但是处理对象是非常有效的
...
# 不需要定义对象在给对象赋值之前
some_var = 5  # 约定是使用带下划线的小写 (lower_case_with_underscores)
some_var  # => 5
